...
INSERT INTO `<<prefix>>categories` (`id`, `translation_lang`, `translation_of`, `parent_id`, `name`, `slug`, `description`, `picture`, `icon_class`, `lft`, `rgt`, `depth`, `active`) VALUES
...
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(1, 'getSearchForm', 'Search Form Area', NULL, 'home.inc.search', NULL, 0, 0, 0, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(2, 'getSponsoredPosts', 'Sponsored Ads', NULL, 'home.inc.featured', NULL, 0, 2, 3, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(3, 'getLatestPosts', 'Latest Ads', NULL, 'home.inc.latest', NULL, 0, 4, 5, 1, 1);
...
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(5, 'getLocations', 'Locations & Country Map', NULL, 'home.inc.locations', NULL, 0, 8, 9, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(6, 'getFeaturedPostsCompanies', 'Companies', NULL, 'home.inc.companies', NULL, 0, 10, 11, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(7, 'getStats', 'Mini Stats', NULL, 'home.inc.stats', NULL, 0, 12, 13, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(8, 'getTopAdvertising', 'Advertising #1', NULL, 'layouts.inc.advertising.top', NULL, 0, 14, 15, 1, 0);
INSERT INTO `<<prefix>>home_sections` (`id`, `method`, `name`, `value`, `view`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(9, 'getBottomAdvertising', 'Advertising #2', NULL, 'layouts.inc.advertising.bottom', NULL, 0, 16, 17, 1, 0);
...
(1, 'en', 1, 'home', '{app_name} - Geolocalized Job Board Script', 'Welcome to {app_name} : 100% Job Board. Find a job near you. Simple, fast and efficient - {country}', '{app_name}, {country}, jobs ads, jobs, ads, script, app, premium jobs', 1),
...
(1, 'en', 1, 'Regular List', 'FREE', NULL, 0, 'Display ads during 7 days', '0.00', 'USD', 7, 0, 2, 3, 1, 0),
(2, 'en', 2, 'Premium 30 days', 'Urgent', 'red', 0, 'Display ads during 30 days', '99.00', 'USD', 30, 0, 4, 5, 1, 0),
(3, 'en', 3, 'Premium 90 days', 'Premium', 'green', 1, 'Display ads during 90 days', '129.00', 'USD', 90, 0, 6, 7, 1, 0);
...
--
-- Truncate table before insert `<<prefix>>salary_types`
--

TRUNCATE TABLE `<<prefix>>salary_types`;
--
-- Dumping data for table `<<prefix>>salary_types`
--

INSERT INTO `<<prefix>>salary_types` (`id`, `translation_lang`, `translation_of`, `name`, `lft`, `rgt`, `depth`, `active`) VALUES
...
(1, 'FI', 1, 1, 'Administrator', 'Administrator', '+19875754676', 0, NULL, 'admin@yoursite.com', '$2y$10$k5jUtH2EYKl9F.5rT5A4SeCU9k6GLjfxESPggYToigaZpbgHIYKpW', 'Br2KkFuD5ighe1JkSuZhWnGAfzbZeHUtRmfwafLSsw2L3HurBF0HbBX4M9fw', 1, 0, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, 1, 1, 0, 0, '2015-09-29 14:39:54', '2015-09-28 12:42:23', '2015-09-29 14:40:25', NULL);
