...
--
-- Indexes for table `<<prefix>>resumes`
--
...
--
-- AUTO_INCREMENT for table `<<prefix>>resumes`
--
ALTER TABLE `<<prefix>>resumes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Structure de la table `<<prefix>>salary_types`
--

DROP TABLE IF EXISTS `<<prefix>>salary_types`;
CREATE TABLE `<<prefix>>salary_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `translation_lang` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `translation_of` int(10) UNSIGNED DEFAULT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Indexes for table `<<prefix>>salary_types`
--
ALTER TABLE `<<prefix>>salary_types`
  ADD PRIMARY KEY (`id`),
  ADD KEY `translation_lang` (`translation_lang`),
  ADD KEY `translation_of` (`translation_of`),
  ADD KEY `active` (`active`);
...
--
-- AUTO_INCREMENT for table `<<prefix>>salary_types`
--
ALTER TABLE `<<prefix>>salary_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
