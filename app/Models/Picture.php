	...
	public function setFilenameAttribute($value)
	{
		...
		try {
			if (fileIsUploaded($value)) {
				...
				// Image default sizes
				$width = (int)config('icetea.core.picture.size.width', 1000);
				$height = (int)config('icetea.core.picture.size.height', 1000);
				...
				if (starts_with($value, config('icetea.core.picture.default'))) {
					$value = null;
				} else {
