...
class Company extends BaseModel
{
    ...
    */
    ...
    public function getLicenseHtml()
    {
        ...
        // Get logo
        $out = '<img src="' . resize($this->business_license, 'small') . '" data-toggle="tooltip" title="' . $this->name . '"' . $style . '>';
    ...
    */
    ...
    /*
      ...
      |--------------------------------------------------------------------------
      */
    public function setBusinessLicenseAttribute($value)
    {
        $attribute_name = 'business_license';
    ...
    {
        $attr = ['countryCode' => config('country.icode'), 'id' => $this->id, 'companySlug' => $this->slug];
    ...
    {
        return ajaxCheckboxDisplay($this->{$this->primaryKey}, $this->getTable(), 'verified', $this->verified);
    }
