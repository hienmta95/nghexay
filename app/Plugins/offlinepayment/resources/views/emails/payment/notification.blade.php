...
@section('title', trans('offlinepayment::mail.payment_notification_title'))
    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0; display: inline-block; max-width: 100%; word-wrap: break-word;">{!! trans('offlinepayment::mail.payment_notification_content_1', [
                        'advertiserName' => $post->contact_name,
                        'title'          => $post->title
                    ]) !!}
                    {!! trans('offlinepayment::mail.payment_notification_content_2', [
                        'adId'              => $post->id,
                    ...
                    {!! trans('offlinepayment::mail.payment_notification_content_3') !!}
                    {!! trans('offlinepayment::mail.payment_notification_content_4', ['appName' => config('app.name')]) !!}</p>
            </td>
        </tr>
    </table>
    </div>
