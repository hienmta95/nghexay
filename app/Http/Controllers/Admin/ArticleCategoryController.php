...
class ArticleCategoryController extends PanelController
{
	public $parentId = 0;
	...
	public function setup()
	{
		...
		*/
		...
		$this->xPanel->setRoute(admin_uri('article_categories'));
		$this->xPanel->setEntityNameStrings(trans('admin::messages.article_category'), trans('admin::messages.article_categories'));
		...
		*/
		...
		$this->xPanel->addField([
			...
			'upload' => true,
			'disk'   => 'public',
			'hint'   => trans('admin::messages.Used in the article_categories area on the homepage (Related to the type of display: "Picture as Icon").'),
		]);
		$this->xPanel->addField([
			'name'        => 'icon_class',
			...
			'allows_null' => true,
			'hint'        => trans('admin::messages.Used in the article_categories area on the home & sitemap pages.'),
		]);
		$this->xPanel->addField([
			'name'  => 'active',
			'label' => trans("admin::messages.Active"),
