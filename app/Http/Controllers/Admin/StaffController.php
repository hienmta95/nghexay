...
class StaffController extends PanelController
{
	...
	public function setup()
	{
		...
		*/
		...
		$this->xPanel->setRoute(admin_uri('staffs'));
		$this->xPanel->setEntityNameStrings(trans('admin::messages.user'), 'Admin');
		if (!request()->input('order')) {
			$this->xPanel->orderBy('created_at', 'DESC');
		}
		$this->xPanel->where('is_admin','=',1);
        ...
        /*$this->xPanel->addFilter([
            ...
            [
                1 => trans('admin::messages.Employer'),
                2 => trans('admin::messages.Candidate'),
            ],
            function ($value) {
