...
@section('title', trans('mail.post_sent_by_email_title', ['appName' => config('app.name'), 'countryCode' => config('country.code')]))
    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;"><?php $attr = ['slug' => slugify($post->title), 'id' => $post->id]; ?>
                    {!! trans('mail.post_sent_by_email_content_1', ['senderEmail' => $mailData->sender_email]) !!}
                    {!! trans('mail.post_sent_by_email_content_2') !!}
                    <br><br>{{ trans('mail.Job URL') }} : <a href="{{ lurl($post->uri, $attr) }}">{{ lurl($post->uri, $attr) }}</a><br>
                </p>
            </td>
        </tr>
    </table>
