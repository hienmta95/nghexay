                        ...
                        <div class="panel panel-default">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center mb30">
                                            <div class="row row-centered">
                                                <div class="col-md-12 col-centered small-gutter">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mb5">
                                                            <a href="{{ lurl('auth/facebook') }}" class="btn btn-fb btn-block"><i
                                                                        class="icon-facebook"></i> {!! t('Connect with Facebook') !!}
                                                            </a>
                                                    </div>
                                                    <div class="col-md-6 mb5">
                                                            <a href="{{ lurl('auth/google') }}" class="btn btn-danger btn-block"><i
                            ...
                            <!-- Login -->
                                <div class="form-group <?php echo (isset($errors) and $errors->has('login')) ? 'has-error' : ''; ?>">
                                    <label for="login"
                                           class="control-label">{{ t('Login') . ' (' . getLoginLabel() . ')' }}
                                        :</label>
                                    <div class="input-icon"><i class="icon-user fa"></i>
                                        <input id="login" name="login" type="text" placeholder="{{ getLoginLabel() }}"
                                               class="form-control" value="{{ $loginValue }}">
                                    </div>
                                </div>
                            ...
                            <!-- Submit -->
                                <div class="form-group">
                                    ...
                                    <p class="mt-20">
                                        {{ t('Don\'t have an account?') }} <a
                                                href="{{ lurl(trans('routes.register')) }}">
                                            {{ t('Sign Up') }}
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div class="panel-footer">
                                <label class="checkbox pull-left input-btn-padding">
                                    <input type="checkbox" value="1" name="remember"
                                           id="remember"> {{ t('Keep me logged in') }}
                                </label>
