...
@section('header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{ admin_url('dashboard') }}">{{ trans('admin::messages.dashboard') }}</a></li>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            @if ($xPanel->hasAccess('list'))
                <a href="{{ url($xPanel->route) }}"><i
                            class="fa fa-angle-double-left"></i> {{ trans('admin::messages.back_to_all') }} <span
                            class="text-lowercase">{{-- $xPanel->entity_name_plural --}}</span></a><br><br>
            @endif
