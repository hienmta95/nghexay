...
<body class="hold-transition {{ config('icetea.admin.skin') }} sidebar-mini">
    <!-- Site wrapper -->
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-mini">{!! config('icetea.admin.logo_mini') !!}</span>
      ...
      <footer class="main-footer">
        @if (config('icetea.admin.show_powered_by'))
