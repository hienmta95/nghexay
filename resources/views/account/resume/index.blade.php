...
@section('content')
    ...
    <div class="inner-box">
        ...
        <div class="mb30">
            <a href="{{ lurl('account/resumes/create') }}" class="btn btn-default"><i
                        class="icon-plus"></i> {{ t('Add a new resume') }}</a>
        </div>
        <br>
                                ...
                                @if ($resume->user_id==$user->id)
                                    <p>
                                        <a class="btn btn-primary btn-sm"
                                           href="{{ lurl('account/resumes/' . $resume->id . '/edit') }}">
                                            <i class="fa fa-edit"></i> {{ t('Edit') }}
                                        </a>
                                    </p>
                                    <p>
                                        <a class="btn btn-danger btn-sm delete-action"
                                           href="{{ lurl('account/resumes/'.$resume->id.'/delete') }}">
                                            <i class="fa fa-trash"></i> {{ t('Delete') }}
                                        </a>
                                    </p>
                                @endif
