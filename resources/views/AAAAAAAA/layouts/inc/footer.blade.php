...
<div class="jp_main_footer_img_wrapper" style="background: url(refactor-theme/images/header/footer_bg.jpg) 50% 0 repeat-y;">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper2">
							<div class="jp_footer_candidate">
								<h2>CÔNG TY TNHH XÂY DỰNG VÀ CÔNG NGHỆ BẢO AN</h2>
								<div class="company-info">
									<ul>
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Địa chỉ trụ sở chính: Số 1, Ngách 80 Ngõ 592 Đường Trường Chinh, Phường Khương Thượng, Quận Đống Đa, Thành phố Hà Nội </a></li>
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Giấy chứng nhận ĐKKD số 0108083227 do Phòng ĐKKD Sở KH&ĐT Hà Nội cấp lần đầu ngày 06/12/2017.</a></li>
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Số điện thoại: 0246 66 625 256</a></li>
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Email: contact@nghexay.com</a></li>
									</ul>
								</div>
							</div>
						</div>
									...
									@if (isset($pages) and $pages->count() > 0)
										@foreach($pages as $page)
											<li>
                                                ...
                                                ?>
												@if (!empty($page->external_link))
													<a href="{!! $page->external_link !!}" rel="nofollow" {!! $linkTarget !!}><i class="fa fa-caret-right" aria-hidden="true"></i> {{ $page->name }} </a>
												@else
                                                    <?php $attr = ['slug' => $page->slug]; ?>
													<a href="{{ lurl(trans('routes.v-page', $attr), $attr) }}" {!! $linkTarget !!}><i class="fa fa-caret-right" aria-hidden="true"></i> {{ $page->name }} </a>
												@endif
											</li>
										@endforeach
									@endif
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper3">
							<div class="jp_footer_candidate">
								...
								<h2>{{ t('Contact & Sitemap') }}</h2>
								<ul>

									<li><a href="{{ lurl(trans('routes.contact')) }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Contact') }} </a></li>
                                    <?php $attr = ['countryCode' => config('country.icode')]; ?>
									<li><a href="{{ lurl(trans('routes.v-companies-list', $attr), $attr) }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Companies') }} </a></li>
									<li><a href="{{ lurl(trans('routes.v-sitemap', $attr), $attr) }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Sitemap') }} </a></li>
									@if (\App\Models\Country::where('active', 1)->count() > 1)
										<li><a href="{{ lurl(trans('routes.countries')) }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Countries') }} </a></li>
									@endif
							...
							<div class="jp_footer_candidate">
								...
								<ul>
									@if (!auth()->user())
										<li>
											@if (config('settings.security.login_open_in_modal'))
												<a href="#quickLogin" data-toggle="modal"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Log In') }} </a>
											@else
												<a href="{{ lurl(trans('routes.login')) }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Log In') }} </a>
											@endif
										</li>
										<li><a href="{{ lurl(trans('routes.register')) }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Register') }} </a></li>
									@else
										<li><a href="{{ lurl('account/dashboard') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Personal Home') }} </a></li>
										@if (isset(auth()->user()->user_type_id))
											@if (in_array(auth()->user()->user_type_id, [1]))
												<li><a href="{{ lurl('account/my-posts') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('My ads') }} </a></li>
												<li><a href="{{ lurl('account/companies') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('My companies') }} </a></li>
											@endif
											@if (in_array(auth()->user()->user_type_id, [2]))
												<li><a href="{{ lurl('account/resumes') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('My resumes') }} </a></li>
												<li><a href="{{ lurl('account/favourite') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ t('Favourite jobs') }} </a></li>
											@endif
										@endif
									@endif
								</ul>
