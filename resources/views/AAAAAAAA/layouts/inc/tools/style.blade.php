...
if (!empty(config('settings.style.body_background_color')) or !empty(config('settings.style.body_background_image'))) {
	$cssBuffer .= '#wrapper { background-color: transparent; }';
}
...
if (!empty(config('settings.style.header_sticky'))) {
	$cssBuffer .= '.navbar-site { position: fixed !important; }';
} else {
	$cssBuffer .= '.navbar-site { position: absolute !important; }';
}
if (!empty(config('settings.style.header_height'))) {
	...
	$cssBuffer .= '.header { min-height: ' . $headerHeight . 'px; }';
	$cssBuffer .= '.navbar-brand {';
	...
	$cssBuffer .= '.logo { height: ' . $headerHeight . 'px; }';
	$cssBuffer .= '.logo-title { padding-top: ' . $padding . 'px; }';
	$cssBuffer .= '.navbar-left { margin-top: ' . $margin . 'px; }';
	$cssBuffer .= '.navbar-right { margin-top: ' . $margin . 'px; }';
	$cssBuffer .= '}';
}
if (!empty(config('settings.style.header_background_color'))) {
	$cssBuffer .= '.navbar-default { background-color: ' . config('settings.style.header_background_color') . '; }';
}
if (!empty(config('settings.style.header_bottom_border_width'))) {
	...
	$cssBuffer .= '.navbar-default { border-bottom-width: ' . $headerBottomBorderSize . '; }';
}
if (!empty(config('settings.style.header_bottom_border_color'))) {
	$cssBuffer .= '.navbar-default { border-bottom-color: ' . config('settings.style.header_bottom_border_color') . '; }';
}
if (!empty(config('settings.style.header_link_color'))) {
	$cssBuffer .= '@media (min-width: 768px) {';
	$cssBuffer .= '.navbar-default .navbar-nav > li > a {';
	$cssBuffer .= 'color: ' . config('settings.style.header_link_color') . ';';
	$cssBuffer .= '}';
	$cssBuffer .= '}';

	$cssBuffer .= '.navbar-default .navbar-nav > .open > a,';
	$cssBuffer .= '.navbar-default .navbar-nav > .open > a:focus,';
	$cssBuffer .= '.navbar-default .navbar-nav > .open > a:hover {';
	$cssBuffer .= 'color: ' . config('settings.style.header_link_color') . ';';
	$cssBuffer .= '}';
}
if (!empty(config('settings.style.header_link_color_hover'))) {
	$cssBuffer .= '@media (min-width: 768px) {';
	$cssBuffer .= '.navbar-default .navbar-nav > li > a:hover,';
	$cssBuffer .= '.navbar-default .navbar-nav > li > a:focus {';
	$cssBuffer .= 'color: ' . config('settings.style.header_link_color_hover') . ';';
	$cssBuffer .= '}';
	$cssBuffer .= '}';
}
...
if (!empty(config('settings.style.btn_post_bg_top_color')) || !empty(config('settings.style.btn_post_bg_bottom_color'))) {
	...
	$cssBuffer .= 'li.postadd > a.btn-add-listing,';
...
if (!empty(config('settings.listing.grid_view_cols'))) {
	...
	if (config('lang.direction') == 'rtl') {
		$cssBuffer .= '.item-list.make-grid { width: ' . $gridWidth . '%; }';

		/* Ribbons */
		$cssBuffer .= '.item-list.make-grid .cornerRibbons { right: -' . $gridRibbonLeft . '%; top: 8%; }';
		$cssBuffer .= '.noSideBar .item-list.make-grid .cornerRibbons { right: -' . $noSidebarGridRibbonLeft . '%; top: 8%; }';

		/* Ribbons: Media Screen - Dynamic */
		$cssBuffer .= '@media (min-width: 992px) and (max-width: 1119px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons { right: -' . $gridRibbonLeft992 . '%; top: 8%; }';
		$cssBuffer .= '.noSideBar .item-list.make-grid .cornerRibbons { right: -' . $noSidebarGridRibbonLeft992 . '%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (min-width: 768px) and (max-width: 991px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons { right: -' . $gridRibbonLeft768 . '%; top: 8%; }';
		$cssBuffer .= '.noSideBar .item-list.make-grid .cornerRibbons { right: -' . $noSidebarGridRibbonLeft768 . '%; top: 8%; }';
		$cssBuffer .= '}';
		/* Ribbons: Media Screen - Fix */
		$cssBuffer .= '@media (max-width: 767px) {';
		$cssBuffer .= '.item-list.make-grid { width: 50%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 767px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { right: -10%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 736px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { right: -12%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 667px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { right: -13%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 568px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { right: -14%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 480px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { right: -22%; top: 8%; }';
		$cssBuffer .= '}';

		/* Item Border */
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(4n+4) { border-left: solid 1px #ddd; }';
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(3n+3) { border-left: solid 1px #ddd; }';
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(' . $gridViewCols . 'n+' . $gridViewCols . ') { border-left: none; }';
		$cssBuffer .= '@media (max-width: 991px) {';
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(' . $gridViewCols . 'n+' . $gridViewCols . ') {';
		...
		/* Ribbons */
		$cssBuffer .= '.item-list.make-grid .cornerRibbons { left: -' . $gridRibbonLeft . '%; top: 8%; }';
		$cssBuffer .= '.noSideBar .item-list.make-grid .cornerRibbons { left: -' . $noSidebarGridRibbonLeft . '%; top: 8%; }';

		/* Ribbons: Media Screen - Dynamic */
		$cssBuffer .= '@media (min-width: 992px) and (max-width: 1119px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons { left: -' . $gridRibbonLeft992 . '%; top: 8%; }';
		$cssBuffer .= '.noSideBar .item-list.make-grid .cornerRibbons { left: -' . $noSidebarGridRibbonLeft992 . '%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (min-width: 768px) and (max-width: 991px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons { left: -' . $gridRibbonLeft768 . '%; top: 8%; }';
		$cssBuffer .= '.noSideBar .item-list.make-grid .cornerRibbons { left: -' . $noSidebarGridRibbonLeft768 . '%; top: 8%; }';
		$cssBuffer .= '}';
		/* Ribbons: Media Screen - Fix */
		$cssBuffer .= '@media (max-width: 767px) {';
		$cssBuffer .= '.item-list.make-grid { width: 50%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 767px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { left: -10%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 736px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { left: -12%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 667px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { left: -13%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 568px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { left: -14%; top: 8%; }';
		$cssBuffer .= '}';
		$cssBuffer .= '@media (max-width: 480px) {';
		$cssBuffer .= '.item-list.make-grid .cornerRibbons, .noSideBar .item-list.make-grid .cornerRibbons { left: -22%; top: 8%; }';
		$cssBuffer .= '}';

		/* Item Border */
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(4n+4) { border-right: solid 1px #ddd; }';
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(3n+3) { border-right: solid 1px #ddd; }';
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(' . $gridViewCols . 'n+' . $gridViewCols . ') { border-right: none; }';
		$cssBuffer .= '@media (max-width: 991px) {';
		$cssBuffer .= '.adds-wrapper .item-list.make-grid:nth-child(' . $gridViewCols . 'n+' . $gridViewCols . ') {';
