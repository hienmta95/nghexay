            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="{{ url(config('app.locale') . '/') }}" class="navbar-brand logo logo-title">
                        <img src="{{ \Storage::url(config('settings.app.logo', 'app/default/logo.png')) . getPictureVersion() }}"
                             style="width:auto; height:40px; float:left; margin:20px 5px 0 0;"/>
                    </a>
                </div>
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        @if (!auth()->check())
                            <li><a href="{{ url(config('app.locale') . '/' . trans('routes.login')) }}"><i
                                            class="icon-user fa"></i> {{ t('Log In') }}</a></li>
                            <li><a href="{{ url(config('app.locale') . '/' . trans('routes.register')) }}"><i
                                            class="icon-user-add fa"></i> {{ t('Register') }}</a></li>
                            <li class="postadd">
                                <a class="btn btn-block btn-post btn-add-listing"
                                   href="{{ url(config('app.locale') . '/posts/create') }}">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu user-menu">
                                    ...
                                    @if (in_array(auth()->user()->user_type_id, [1]))
                                        <li><a href="{{ url(config('app.locale') . '/account/companies') }}"><i
                                                        class="icon-town-hall"></i> {{ t('My companies') }} </a></li>
                                        <li><a href="{{ url(config('app.locale') . '/account/my-posts') }}"><i
                                                        class="icon-th-thumb"></i> {{ t('My ads') }} </a></li>
                                        <li><a href="{{ url(config('app.locale') . '/account/pending-approval') }}"><i
                                                        class="icon-hourglass"></i> {{ t('Pending approval') }} </a>
                                        </li>
                                        <li><a href="{{ url(config('app.locale') . '/account/archived') }}"><i
                                                        class="icon-folder-close"></i> {{ t('Archived ads') }} </a></li>
                                        <li><a href="{{ url(config('app.locale') . '/account/conversations') }}"><i
                                                        class="icon-mail-1"></i> {{ t('Conversations') }} </a></li>
                                        <li><a href="{{ url(config('app.locale') . '/account/transactions') }}"><i
                                                        class="icon-money"></i> {{ t('Transactions') }} </a></li>
                                    @endif
                                    @if (in_array(auth()->user()->user_type_id, [2]))
                                        <li><a href="{{ url(config('app.locale') . '/account/resumes') }}"><i
                                        ...
                                        <li><a href="{{ url(config('app.locale') . '/account/saved-search') }}"><i
                                                        class="icon-star-circled"></i> {{ t('Saved searches') }} </a>
                                        </li>
                                        <li><a href="{{ url(config('app.locale') . '/account/conversations') }}"><i
                                                        class="icon-mail-1"></i> {{ t('Conversations') }} </a></li>
                                    @endif
