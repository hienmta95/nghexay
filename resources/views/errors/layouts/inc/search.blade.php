                    ...
                    <div class="row search-row fadeInUp">
                        <form id="seach" name="search" action="{{ $searchUrl }}" method="GET">
                            ...
                            <div class="col-lg-4 col-sm-5 search-col relative">
                                ...
                                <input type="text" name="q" class="form-control has-icon" placeholder="{{ t('What?') }}"
                                       value="">
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-5 search-col relative locationicon">
                                ...
                                <input type="text" id="loc_search" name="location"
                            ...
                            <div class="col-lg-2 col-sm-2 search-col">
                                <button class="btn btn-primary btn-search btn-block"><i
                                            class="icon-search"></i><strong>{{ t('Find') }}</strong>
                                </button>
                            </div>
                            {!! csrf_field() !!}
