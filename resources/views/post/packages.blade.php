                                            ...
                                            @foreach ($packages as $package)
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="radio">
                                                            <label>
                                                                <input class="package-selection" type="radio"
                                                                       name="package_id"
                                                                ...
                                                                <strong class="tooltipHere" title=""
                                                                        ...
                                                                        data-original-title="{!! $package->description !!}">{!! $package->name . $badge !!} </strong>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <div class="form-group <?php echo (isset($errors) and $errors->has('payment_method_id')) ? 'has-error' : ''; ?>"
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control selecter"
                                                                    name="payment_method_id" id="paymentMethodId">
                                                                @foreach ($paymentMethods as $paymentMethod)
                                                                    @if (view()->exists('payment::' . $paymentMethod->name))
                                                                        <option value="{{ $paymentMethod->id }}"
                                                                                data-name="{{ $paymentMethod->name }}" {{ (old('payment_method_id')==$paymentMethod->id) ? 'selected="selected"' : '' }}>
