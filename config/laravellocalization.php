...
return [
    ...
    // IMPORTANT: 'supportedLocales' isn't used for the script. This has been replaced by the script's Language table. So don't take to account the comments bellow.
