...
namespace Icetea\Admin\app\Http\Controllers\Features;
...
trait SaveActions
{
	...
	{
		$saveAction = session('save_action', config('icetea.admin.default_save_action', 'save_and_back'));
		$saveOptions = [];
		$saveCurrent = [
			'value' => $saveAction,
	...
	public function setSaveAction($forceSaveAction = null)
	{
		if ($forceSaveAction) {
			...
			$saveAction = \Request::input('save_action', config('icetea.admin.default_save_action', 'save_and_back'));
		}
